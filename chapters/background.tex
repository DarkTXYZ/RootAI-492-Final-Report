...
Other than key actions, there will be some specific actions belonging to each faction. We will describe them in detail with an explanation of how each phase of each faction works.
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Birdsong
    \begin{itemize}
      \item Place one wood token at each sawmill.
    \end{itemize}
    \item Daylight    
    \begin{itemize}
      \item Craft any cards in your hand using workshops.
      \item Take up to three of the following actions (plus one per bird suit card you spend):
      \begin{itemize}
        \item Battle
        \item March: Takes two moves
        \item Recruit: Place one warrior at each recruiter.
        \item Build: Place one building in a clearing you rule by spending wood tokens equal to its cost.
        \item Overwork: Spend a card to place one wood token at one sawmill in a clearing whose suit matches the card spent.
      \end{itemize}
    \end{itemize}
    \item Evening
    \begin{itemize}
      \item Draw one card plus one card per draw bonus. (Discard down to five if you have more than five cards.)
    \end{itemize}
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Birdsong
    \begin{itemize}
      \item If your hand is empty, draw 1 card.
      \item Add one or two cards to the Decree.
      \item If you have no roosts, place a roost and 3 warriors in the clearing with the fewest total pieces.
    \end{itemize}
    \item Daylight    
    \begin{itemize}
      \item Craft using roosts.
      \item Resolve the Decree from left column to right, taking one action per card in a matching clearing
    \end{itemize}
    \item Evening
    \begin{itemize}
      \item Score victory point of rightmost empty space on the Roosts track.
      \item Draw one card plus one card per draw bonus. (Discard down to five if you have more than five cards.)
    \end{itemize}
  \end{itemize}
\end{itemize}
