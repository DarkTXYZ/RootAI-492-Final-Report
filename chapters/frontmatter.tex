...
A video game version of Root was released in 2020, but the feedback from the online community stated that the artificial intelligence (AI) in the \RootV{} is lacking and incompetent. Due to that reason, we developed an AI system capable of playing Root. The AI agents can take game state as input and make intelligent decisions in each phase. An AI agent for each of the 2 base factions: ``Marquise'' de Cat and the ``Eyrie'' Dynasties was made in this project.
