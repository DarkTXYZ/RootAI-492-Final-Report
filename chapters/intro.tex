...
This project aims to construct an artificial intelligence (AI) system capable of playing the board game "Root" that is more intelligent than the AIs in the Root video game. The agents will be built using different methods, including Monte Carlo tree search, neural network reinforcement learning, random, human player, etc. Full details on each AI agent implementation method and their concepts are explained in this document.
