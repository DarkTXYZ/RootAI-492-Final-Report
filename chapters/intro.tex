...
Artificial intelligence (AI) has revolutionized the world of video games, by giving players friends to play with or foes to play against. The digital adaptation video game of the \RootB{} is no exception. But there are problems with the AIs in . There are multiple reports by \RootV{} players that the AIs are no longer challenging to play against once you start to know how to play your faction or that the AIs make awful decisions that no humans would ever make in a similar situation.
...
\begin{enumerate}
    ...
    \item Exclude direct integration with \RootV{}, i.e., no pulling data from a running \RootV{}, and no injecting decision to a running \RootV{} via code.
...
\fi}
This project can work as a foundation for future researches on reinforcement learning, asymmetrical games, game AI, and other related topics.
