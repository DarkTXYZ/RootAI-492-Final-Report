...
The video game must support the rules of Root [\ref{brief-rules-of-root}] in the scenario of \Marquise{} versus \Eyrie{}. The scope of the minimal version are as follows:
\begin{enumerate}
    \item Only Marquise 
\end{enumerate}
